...
> **ВАЖНО для ИИ-агентов**: Перед началом работы прочитай:
> 1. `PROJECT.md` — полное описание проекта, архитектура, API, бизнес-процессы
> 2. `CHANGELOG.md` — история изменений (добавляй запись после каждой задачи)
